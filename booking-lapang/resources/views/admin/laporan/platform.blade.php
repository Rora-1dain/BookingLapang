<x-partner-layout :title="'Laporan Keuangan Platform - Super Admin Booking Lapang'">

    <x-admin-sidebar active="laporan" />

    <div class="flex-1 flex flex-col min-h-screen ml-64 bg-background">
        <div class="max-w-[1400px] mx-auto space-y-8 p-6">
...
const dataKomisi = @json($tren['data_komisi']);
