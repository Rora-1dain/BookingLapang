...
<div class="min-h-screen bg-gray-50 py-10">
    <div class="max-w-lg mx-auto">
        <h2 class="text-2xl font-bold text-gray-900 mb-6">Ajukan Lapangan Baru</h2>
        ...
        <div class="bg-white rounded-2xl shadow-sm p-6">
            <form method="POST" action="{{ route('pemilik.lapangan.store') }}">
                @csrf
                ...
                <input type="number" name="harga_per_jam" value="{{ old('harga_per_jam') }}" min="0"
